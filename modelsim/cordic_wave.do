...
add wave -noupdate -radix decimal /cordic_tb/dut/in_x
add wave -noupdate -radix decimal /cordic_tb/dut/in_y
add wave -noupdate -radix unsigned /cordic_tb/out_x
add wave -noupdate -radix decimal /cordic_tb/out_y
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {3031 ps} 0}
